...
public abstract partial class AuthWf
{
    ...
    public class RefreshToken : HttpBase
    {
        ...
        public record Init(RefreshTokenRequestDto Request, Action<AuthResultDto> Callback);
        ...
        {
            var authResult = await this.authApi.RefreshTokenAsync(request: action.Request);
