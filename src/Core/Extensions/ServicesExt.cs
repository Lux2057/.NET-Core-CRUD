namespace CRUD.Core
{
    ...
    public static class ServicesExt
    {
        ...
        {
            services.AddTransient(typeof(IRequestHandler<ReadEntitiesQueryBase<TEntity, TId, TDto>, PaginatedResponseDto<TDto>>), typeof(ReadEntitiesQueryBase<TEntity, TId, TDto>.Handler));
        }
    }
}